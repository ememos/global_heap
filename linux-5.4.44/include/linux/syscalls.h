...
asmlinkage long sys_global_heap_switch(int heap_id);
asmlinkage long sys_global_heap_print_metadata(int heap_id);
asmlinkage long sys_global_heap_switch2(int heap_id, char __user *src, char __user *dst);
asmlinkage long sys_global_heap_remove(int heap_id);
